...
interactive_requirements = ["altair", "jupyterlab", "matplotlib", "pillow"]
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        print("cmake --build . --target pyagave " + " ".join(build_args))
        subprocess.check_call(
            ["cmake", "--build", ".", "--target", "pyagave"] + build_args,
            cwd=self.build_temp,
        )
